...
//    private  AxResultStateEnum stateEnum;
    ...
    public ResponseEntity(Integer code, T body) {
        this.code = code;
        this.body = body;
    }
     ...
     */
    @NotNull
    public static <T> ResponseEntity<T> success(AxResultStateEnum resultStatus, T data) {
        if (resultStatus == null) {
            return new ResponseEntity<>(AxResultStateEnum.SUCCESS.value(), data);
        }
        return new ResponseEntity<>(resultStatus.value(), data);
    }
    ...
    public static <T> ResponseEntity<T> Success(T data) {
        return new ResponseEntity<T>(AxResultStateEnum.SUCCESS.value(), data);
    }
