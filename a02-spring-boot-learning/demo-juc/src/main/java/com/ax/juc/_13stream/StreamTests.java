...
class StreamTest_groupingBy {
    public static void main(String[] args) {
        ...
        personList.add(new Person("Jack", 2, 25, "male", "Washington"));
        personList.add(new Person("Lily", 3, 21, "female", "Washington"));
        personList.add(new Person("Luck", 4, 21, "female", "Washington"));


        // 将员工按薪资是否高于2组
        Map<Boolean, List<Person>> part = personList.stream().collect(Collectors.partitioningBy(x -> x.getSalary() > 2));
        // 将员工按性别分组
