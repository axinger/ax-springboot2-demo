...
public class PersonServiceAop {
    ...
    // 定义切点表达式
    // @Pointcut("@annotation(com.axing.demo.annotation.ApiVersion)")
    // @Pointcut("@within(com.axing.demo.annotation.ApiVersion)")
    // public void service() {
    // }
    ...
    // @Before("@annotation(com.axing.demo.annotation.ApiVersion)")
