$(document).ready(function() {
    ...
    function createWebsocket() {
    	...
    	if ('WebSocket' in window) {
    		websocket = new WebSocket("ws://127.0.0.1:12345/ws?token="+token);
    	} else if ('MozWebSocket' in window) {
    		websocket = new MozWebSocket("ws://127.0.0.1:12345/ws?token="+token);
    	} else {
    		websocket = new SockJS("http://127.0.0.1:12345/ws?token="+token);
    	}
