...
public class MQConsumer {
    ...
    @Service
    @RocketMQMessageListener(topic = Topic.TOPIC_1,
            selectorExpression = "tag2",
            consumerGroup = "Con_Group_Three")
    ...
    @Service
    @RocketMQMessageListener(topic = "TBW102",
            consumerGroup = "Con_Group_Three")
    ...
    // 顺序消费
    @Service
    @RocketMQMessageListener(topic = Topic.sync_user_topic,
