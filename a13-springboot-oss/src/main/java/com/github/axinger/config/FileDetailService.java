...
public class FileDetailService implements FileRecorder {
    ...
    public boolean save(FileInfo info) {
        ...
        boolean b = filePartDetailService.save(detail);
        if (b) {
    ...
    public void update(FileInfo info) {
        ...
        filePartDetailService.update(detail, qw);
    }
    ...
    public FileInfo getByUrl(String url) {
        return toFileInfo(filePartDetailService.getOne(new LambdaQueryWrapper<FileDetail>().eq(FileDetail::getUrl, url)));
    }
    ...
    public boolean delete(String url) {
        filePartDetailService.remove(new LambdaQueryWrapper<FileDetail>().eq(FileDetail::getUrl, url));
        return true;
    }
